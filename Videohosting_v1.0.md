...
2. Система открывает форму загрузки
3. Пользователь выбирает видеофайл
4. Система отображает выбранный видеофайл на форме
5. Пользователь вводит название (UC2.1.2)
6. Пользователь вводит описание (UC2.1.3)
7. Пользователь нажимает "Загрузить"
8. Система проверяет файл и сохраняет видео  

**Альтернативный сценарий:**  
Отсутствует  
**Негативный сценарий:**  
5а.1. Название отсутствует  
6а.1. Неподдерживаемый формат - загрузка отклонена  
