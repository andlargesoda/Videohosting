...
- [Swagger (OpenAPI)](#swagger-openapi)
  ...
  - [Параметры запросов и ответов для методов HTTP](#параметры-запросов-и-ответов-для-методов-http)
...
|role                     |varchar: enum ("Author", "Viewer")               |роль ("Владелец видео", "Зритель")                     |
|created_at               |date                                             |дата и время создания аккаунта                         |
...
|author_id                |integer                                          |идентификатор владельца видео (FK)                     |
|title                    |varchar                                          |название                                               |
|descriprion              |varchar                                          |описание                                               |
|duration                 |varchar                                          |продолжительность                                      |
|status                   |varchar: enum ("", "Viewer")               |статус                                                 |
|age_restriction          |date                                             |дата и время создания аккаунта                         |
|created_at               |date                                             |дата и время создания аккаунта                         |

1) Видеофайлы /videoFiles
2) Просмотры
3) Лайки /likes
...
### HTTP методы API
### Ресурсы API
### Параметры запросов и ответов для методов HTTP